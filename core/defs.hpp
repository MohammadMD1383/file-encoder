...
#define INFO(msg)    std::cerr << "\033[46;97m" "[INFO]:"    "\033[0;36m " msg "\033[0m" << std::endl
#define WARNING(msg) std::cerr << "\033[43;97m" "[WARNING]:" "\033[0;33m " msg "\033[0m" << std::endl
#define ERROR(msg)   std::cerr << "\033[41;97m" "[ERROR]:"   "\033[0;31m " msg "\033[0m" << std::endl
//endregion
